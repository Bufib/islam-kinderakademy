...
const iconNames: Record<AppIconName, PlatformIcon> = {
  ...
  journeys: { ios: 'books.vertical.fill', android: 'auto_stories', web: 'auto_stories' },
  calendar: { ios: 'calendar', android: 'calendar_month', web: 'calendar_month' },
  pass: { ios: 'medal.fill', android: 'workspace_premium', web: 'workspace_premium' },
  profile: { ios: 'person.crop.circle.fill', android: 'person', web: 'person' },
  children: { ios: 'figure.2.and.child.holdinghands', android: 'family_restroom', web: 'family_restroom' },
  messages: { ios: 'bell.fill', android: 'notifications', web: 'notifications' },
  dashboard: { ios: 'square.grid.2x2.fill', android: 'dashboard', web: 'dashboard' },
  curriculum: { ios: 'point.3.connected.trianglepath.dotted', android: 'account_tree', web: 'account_tree' },
  lessons: { ios: 'doc.text.fill', android: 'library_books', web: 'library_books' },
...
export function AppIcon({ name, size = 22, color = '#173D3A', style }: AppIconProps) {
  return (
    <SymbolView
      name={iconNames[name]}
      size={size}
